...
- Event class: [BlockDropsKubeEvent](https://github.com/KubeJS-Mods/KubeJS/tree/2101/common/src/main/java/dev/latvian/mods/kubejs/block/BlockDropsKubeEvent.java)
