...
- Event class: [EntitySpawnedKubeEvent](https://github.com/KubeJS-Mods/KubeJS/tree/2101/common/src/main/java/dev/latvian/mods/kubejs/entity/EntitySpawnedKubeEvent.java)
